          ...
          <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl">
              <div className="rounded-2xl bg-white/10 backdrop-blur-xl border border-white/10 shadow-2xl p-8 sm:p-10">
                ...
                >
                  Be part of a team that's revolutionizing healthcare
                  accessibility. Help us build solutions that impact millions of
                  lives.
                </EditableText>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2
                ...
                data-testid="openings-title"
              >
                Open Positions
              </h2>
              <p
                className="text-xl text-muted-foreground max-w-2xl mx-auto"
                data-testid="openings-description"
              >
                Ready to make a difference? Explore our current job openings and
                find your perfect role in transforming healthcare.
              </p>
            </div>
            ...
            <div className="mb-12 bg-card rounded-xl border border-border p-6">
              ...
              <div className="flex items-center justify-between text-sm text-muted-foreground">
                <span>
                  Showing {filteredJobs.length} of {jobPages.length} jobs
                </span>
            ...
            <div className="text-center mb-16">
              ...
              <div className="mt-12 mb-8">
                <EditableImage
                  ...
                  alt={
                    benefitsSection?.content?.imageAlt ||
                    "Team Benefits & Workplace Culture"
                  }
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="text-center">
                        ...
                        <div className="text-muted-foreground text-sm mt-2">
                          Team collaboration, office spaces, remote work setup
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <section className="py-20 bg-background">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p
                className="text-xl text-muted-foreground max-w-2xl mx-auto"
                data-testid="culture-description"
              >
                Built on shared values that drive everything we do, from product
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              <h2
                ...
                data-testid="career-cta-title"
              >
                Ready to Transform Healthcare with Us?
              </h2>
              <p
                className="text-xl text-white/90 mb-8 max-w-2xl mx-auto"
                data-testid="career-cta-description"
              >
                Join a team that's making healthcare accessible, affordable, and
                effective for millions across Africa and beyond.
              </p>
