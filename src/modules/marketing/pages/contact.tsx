...
const contactSchema = z.object({
  title: z
    .string()
    .optional()
    .refine((val) => !val || TITLE_OPTIONS.includes(val as any), {
...
const userTypeFAQSections = [
  {
    ...
    title: "Patient FAQs",
    description:
      "Common questions from patients about using our digital health platform",
    link: "/patients",
    preview:
      "How do I access my health records? Is telemedicine available? How secure is my data?",
  },
  {
    icon: Stethoscope,
    title: "Physician FAQs",
    description:
      "Questions from healthcare providers about practice integration and patient management",
    link: "/physicians",
    preview:
      "How does EMR integration work? What are the consultation fees? How do I manage virtual appointments?",
  },
  {
    icon: Building2,
    title: "Hospital FAQs",
    description:
      "Hospital administrators' questions about system implementation and patient flow",
    link: "/hospitals",
    preview:
      "What's required for enterprise integration? How does staff training work? What are the implementation timelines?",
  },
  {
    icon: FlaskConical,
    title: "Laboratory FAQs",
    description:
      "Medical lab questions about test integration and result management",
    link: "/laboratories",
    preview:
      "How do we integrate lab systems? What test types are supported? How are results transmitted?",
  },
  {
    icon: Pill,
    title: "Pharmacy FAQs",
    description:
      "Pharmacy partners' questions about prescription management and delivery services",
    link: "/pharmacies",
    preview:
      "How does prescription processing work? What's the revenue model? How do we handle controlled substances?",
  },
  {
    icon: Ambulance,
    title: "Emergency Services FAQs",
    description:
      "Emergency services questions about response coordination and patient data access",
    link: "/emergency",
    preview:
      "How does dispatch integration work? What patient data is available? How do you ensure HIPAA compliance?",
  },
  {
    icon: Shield,
    title: "Insurance FAQs",
    description:
      "Insurance providers' questions about claims processing and member engagement",
    link: "/insurance",
    preview:
      "How does claims automation work? What fraud detection capabilities exist? How do you support value-based care?",
  },
  {
    icon: Heart,
    title: "Corporate FAQs",
    description:
      "Corporate clients' questions about employee wellness programs and healthcare cost reduction",
    link: "/corporates",
    preview:
      "How can MHI reduce healthcare costs? What wellness programs are available? How does HR integration work?",
  },
];
...
export default function Contact() {
  ...
  const form = useForm<ContactFormData>({
    resolver: zodResolver(
      isInvestorForm ? investorContactSchema : contactSchema
    ),
    defaultValues: {
      title: "",
      firstName: "",
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl mx-auto text-center">
              ...
              >
                ...
                hours. Our team is excited to learn more about how we can help
              ...
              <div className="bg-card rounded-xl p-8 border border-border relative overflow-hidden">
                ...
                {isInvestorForm && (
                  <div
                    ...
                    data-testid="investor-info"
                  >
                    <h3 className="font-semibold text-foreground mb-2">
                      Investment Opportunities
                    </h3>
                    <p className="text-sm text-muted-foreground">
                      We're currently seeking strategic investors to accelerate
                      our mission of transforming global healthcare. Share your
                      investment criteria and we'll provide detailed information
                      about our current funding round.
                    </p>
                  </div>
                )}
                          ...
                          <FormItem>
                            ...
                            >
                              ...
                              <SelectContent>
                                ...
                                <SelectItem value="congo-democratic-republic">
                                  Congo (Democratic Republic)
                                </SelectItem>
                                <SelectItem value="congo-republic">
                                  Congo (Republic)
                                </SelectItem>
                                ...
                                <SelectItem value="saint-vincent-and-grenadines">
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-6">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <a
                        href="mailto:info@myhealthintegral.com"
                        className="text-primary hover:underline"
                      >
                        info@myhealthintegral.com
                      </a>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-4 mt-2">
                        <a
                          href="https://wa.me/2348140378613"
                          target="_blank"
                  ...
                  <div
                    className="flex items-start space-x-4"
                    data-testid="contact-consultation"
                  >
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm mb-2">
                        Looking to learn more about our services or schedule a
                        consultation?
                      </p>
                      <a
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm mb-2">
                        Get instant support through our AI-powered chat service
                      </p>
                      <button
                        className="inline-flex items-center text-primary hover:text-primary/80 font-medium"
                    ...
                    <div>
                      ...
                      <div className="mb-3">
                        <p className="text-muted-foreground">
                          Beckley Avenue, Millenium Estate, Gbagada, Lagos,
                          Nigeria
                        </p>
                        <p className="text-muted-foreground text-sm">
                          Operational Headquaters & Innovation Hub
                        </p>
                      </div>
                      <div>
                        <p className="text-muted-foreground">
                          Verulam Way, Cambridge, England
                        </p>
                        <p className="text-muted-foreground text-sm">
                ...
                <div className="bg-muted/30 rounded-lg p-6">
                  ...
                  <p className="text-muted-foreground text-sm leading-relaxed">
                    We value your time and are committed to responding to all
                    inquiries within 24 hours. For urgent matters, our team is
                    available 24/7 to ensure you receive the support you need.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-16">
              ...
              <p
                ...
                data-testid="contact-faq-description"
              >
                Get answers tailored to your specific role in the healthcare
                ecosystem. Click on your role below to see relevant FAQs.
              </p>
            </div>
