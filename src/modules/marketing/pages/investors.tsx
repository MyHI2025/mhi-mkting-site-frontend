            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="hidden lg:block relative">
                <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                  ...
                  {/* Floating Badges */}
                  <div
                    className="absolute top-6 left-6 bg-green-500 text-white px-4 py-2 rounded-full flex items-center gap-2"
                  ...
                  <div
                    className="absolute bottom-6 right-6 bg-red-500 text-white px-4 py-2 rounded-full flex items-center gap-2"
