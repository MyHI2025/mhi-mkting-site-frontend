...
import type { TeamMember } from "@myhi2025/shared";
...
const coreValues = [
  {
    ...
    description:
      "Every decision we make prioritizes patient outcomes and accessibility to quality healthcare.",
    color: "text-red-600",
  },
  {
    icon: Globe,
    ...
    description:
      "Breaking down barriers to healthcare access regardless of location, economic status, or background.",
    color: "text-blue-600",
  },
  {
    icon: Zap,
    ...
    description:
      "Leveraging cutting-edge technology to solve complex healthcare challenges with simple, effective solutions.",
  ...
  },
  {
    ...
    description:
      "Maintaining the highest standards of data security, privacy, and regulatory compliance in all operations.",
  ...
  },
  {
    ...
    description:
      "Fostering seamless collaboration between patients, providers, and healthcare partners in our ecosystem.",
  ...
  },
  {
    ...
    description:
      "Delivering quantifiable improvements in healthcare outcomes, efficiency, and patient satisfaction.",
...
const milestones = [
  {
    ...
    description:
      "Recruited founding volunteer team and initiated digital platform development with full code focus",
  },
  {
    year: "Q2 2024",
    title: "Company Formation & Market Validation",
    description:
      "Legally registered in UK, developed brand identity, completed digital health market analysis and scaled to 50-volunteer team",
  },
  {
    year: "Q4 2024",
    title: "Informational Website Launch",
    description:
      "Launched informational website showcasing platform features, value propositions and user types",
  },
  {
    year: "Q1 2025",
    title: "Company Registration in Nigeria",
    description:
      "Registered company in Nigeria on 17th March 2025 to expand operations and serve the African market",
  },
  {
    year: "Q3 2025",
    title: "Product Validation & User Engagement",
    description:
      "Completed platform feature validation and launched direct user engagement initiatives",
  },
  {
    year: "Q4 2025",
    title: "Market Launch & Platform Deployment",
    description:
      "Launching MVP (Patient, Private Physician & Pharmacy modules) with informational website and social media presence",
  },
];
...
export default function About() {
  useSEO({
    ...
    description:
      "Learn about My Health Integral's mission to revolutionize global healthcare. Meet our leadership team and discover our commitment to accessible, quality healthcare for everyone.",
    ogTitle: "About My Health Integral - Healthcare Innovation Leaders",
    ogDescription:
      "Discover our mission to transform healthcare delivery through digital innovation. Meet the team building the future of global healthcare.",
        ...
        <section className="hero-gradient text-white py-20 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div className="max-w-4xl mx-auto text-center animate-pulse">
              ...
              >
                We're building the world's most comprehensive digital healthcare
                platform, connecting patients, providers, and partners to
                deliver accessible, quality care globally.
              </p>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p
                  ...
                  data-testid="who-we-are-subtitle"
                >
              ...
              <div className="prose prose-lg mx-auto text-center">
                <p
                  ...
                  data-testid="who-we-are-description"
                >
                  Combining advanced technology with extensive healthcare
                  expertise, MHI streamlines the complex landscape of healthcare
                  services, making quality care accessible to everyone,
                  everywhere.
                </p>
              </div>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-12">
                ...
                >
                  ...
                  <div className="p-8">
                    ...
                    >
                      Our mission at MHI is to empower both patients and
                      healthcare providers by providing a technologically
                      advanced platform that simplifies healthcare processes,
                      enhances access to quality care, and improves overall
                      health outcomes. We strive to bridge critical healthcare
                      gaps with innovation and user-centric solutions.
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="p-8">
                    ...
                    >
                      ...
                      health services, transforming the way healthcare is
                      accessed and delivered worldwide. We aim to make MHI
                      synonymous with trust, innovation, and efficiency,
                      enabling a future where healthcare is universally
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative min-h-[600px] flex flex-col md:flex-row">
            ...
            <div className="w-full md:w-1/2 flex items-center bg-gradient-to-br from-orange-50 to-peach-100 dark:from-orange-950/30 dark:to-peach-950/30 p-8 md:p-16">
              <div
                ...
                data-testid="founder-story-intro"
              >
                <h2
                  className="text-2xl md:text-3xl uppercase tracking-wider text-primary font-bold mb-8"
                  data-testid="founder-story-title"
                >
                  Our Founder's Why
                </h2>
                <blockquote className="mb-8">
                  <p className="text-xl md:text-2xl font-serif leading-relaxed text-foreground mb-6">
                    "Healthcare became personal when I realized that the system
                    designed to heal was actually harming the people I loved
                    most."
                  </p>
          ...
          <div className="relative">
            ...
            <div
              ...
              data-testid="founder-story-childhood"
            >
              <div className="absolute inset-0">
                <img
              ...
              <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="max-w-2xl">
                  ...
                  <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
                    As a constantly sick child, I was taken from hospital to
                    hospital. Each gave different diagnoses with no reference to
                    previous treatments. The fragmented care made me worse,
                    pushing me toward life-threatening conditions because
                    healthcare providers couldn't communicate.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div
              className="relative min-h-[500px] flex items-center bg-slate-50 dark:bg-slate-900/30"
              data-testid="founder-story-mother"
            >
              <div className="absolute inset-0">
                <img
                  src={motherCare}
              ...
              <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="max-w-2xl ml-auto">
                  ...
                  <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
                    Hospital after hospital, each doctor knew nothing of her
                    medical history. Three different doctors prescribed
                    completely different medications for the same condition.
                    Test results went missing, leaving her with no answers and
                    no treatment.
                  </p>
                </div>
              </div>
            ...
            <div
              className="relative min-h-[500px] flex items-center"
              data-testid="founder-story-aunt"
            >
              <div className="absolute inset-0">
                <img
                  src={familyLoss}
              ...
              <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="max-w-2xl">
                  ...
                  <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
                    Living in a rural village, she couldn't access necessary
                    care. No remote monitoring, no way for doctors to intervene
                    in time. When it became an emergency, no emergency services
                    were available. Hours later, we lost her to a preventable
                    condition.
                  </p>
                </div>
              </div>
          ...
          <div
            className="relative bg-slate-900 dark:bg-slate-950 text-white py-24 overflow-hidden"
            data-testid="founder-story-turning-point"
          >
                ...
                <div className="relative bg-slate-800/60 backdrop-blur-md border border-primary/40 rounded-2xl p-10 md:p-12 shadow-2xl">
                  ...
                  <div className="pt-8 border-t border-white/20">
                    <p className="text-xl md:text-2xl font-medium text-white leading-relaxed">
                      Every challenge we've faced has only made us stronger.
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {coreValues.map((value, index) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`w-12 h-12 rounded-lg flex items-center justify-center mb-6 ${value.color} bg-current/10`}
                    >
        ...
        <section className="py-20 section-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              >
                Meet the visionary leaders driving healthcare transformation and
        ...
        <section className="py-20 section-teal-light">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              >
                Key milestones in our mission to transform global healthcare
                delivery.
              </p>
            </div>
        ...
        <section className="py-20 hero-gradient text-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center">
              ...
              >
                Whether you're a patient seeking better care, a healthcare
                provider looking to expand your reach, or a partner ready to
                transform healthcare delivery—we'd love to work with you.
              </p>
