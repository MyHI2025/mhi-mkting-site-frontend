...
import type { SystemSetting } from "@myhi2025/shared";
...
export default function AdminSettingsPage() {
  ...
  const { data: gaSetting, isLoading } = useQuery<SystemSetting | null>({
    ...
    queryFn: async () => {
      const response = await authApiRequest(
        "/api/v1/admin/settings/ga_measurement_id"
      );
  ...
  const saveMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        ...
        description:
          "Google Analytics measurement ID has been saved successfully.",
      });
    },
    onError: (error: Error) => {
      toast({
  ...
  const hasGaId =
    !!gaSetting?.value || !!import.meta.env.VITE_GA_MEASUREMENT_ID;
          ...
          <CardContent className="space-y-4">
            ...
            <Alert className="bg-blue-50 dark:bg-blue-950 border-blue-200 dark:border-blue-800">
              ...
              <AlertDescription className="text-sm text-blue-800 dark:text-blue-200">
                <strong>Configuration Priority:</strong> Database value (below)
                takes precedence over environment variable. If no database value
                is set, the system falls back to VITE_GA_MEASUREMENT_ID.
              </AlertDescription>
            </Alert>
            ...
            <div className="space-y-6 pt-4 border-t">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">
                  VITE_GA_MEASUREMENT_ID - Set this in your environment/secrets
                  configuration
                </p>
              </div>
                ...
                <Alert>
                  ...
                  <AlertDescription>
                    ...
                    <ol className="list-decimal list-inside mt-2 space-y-1">
                      ...
                      <li>
                        Select your web stream (or create one if it doesn't
                        exist)
                      </li>
                      <li>Copy the Measurement ID (starts with "G-")</li>
                      <li>
                        Add it to the Secrets tab with key:{" "}
              ...
              {hasGaId && (
                <Alert className="bg-green-50 dark:bg-green-900/20 border-green-200 dark:border-green-800">
                  ...
                  <AlertDescription className="text-green-800 dark:text-green-200">
                    Google Analytics is properly configured and will start
                    tracking once users consent to analytics cookies.
                  </AlertDescription>
                </Alert>
              )}
            </div>
            ...
            <div className="flex items-start gap-3 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Your website displays a cookie consent banner to all new
                  visitors. Users can accept, reject, or customize their cookie
                  preferences. Analytics tracking only activates after explicit
                  user consent.
                </p>
              </div>
            </div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400">
                      Google Analytics for tracking user behavior and site
                      performance
                    </p>
                  </div>
                </li>
